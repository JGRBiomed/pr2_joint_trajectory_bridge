"""autogenerated by genpy from pr2_joint_trajectory_bridge/JointTrajectoryBridge.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','string[]','pr2_joint_trajectory_bridge/JointTrajectoryPointBridge[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointTrajectoryBridge, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.points = []
      for i in range(0, length):
        val1 = pr2_joint_trajectory_bridge.msg.JointTrajectoryPointBridge()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
